...
const authSlice = createSlice({
  ...
  reducers: {
    logout: (state) => {
      ...
      localStorage.setItem("guestId", state.guestId); // set new gust Id in local storage
    },
    generateNewGuesttId: (state) => {
...
export const { logout, generateNewGuesttId } = authSlice.actions;

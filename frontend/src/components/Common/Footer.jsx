...
const handleSubscribe = async (e) => {
                ...
                <li>
                  <button
                    onClick={() =>
                      handleShow(
                        "FAQs",
                        "❓ Q: How can I track my order?\n✔️ A: Email us with youery at dipdopdrip@gmail.com we will attend to your query as soon as possible\n\n❓ Q: Return policy?\n✔️ A: 3-day easy returns available."
                      )
                    }
                    className="hover:text-indigo-500 transition-colors"
                  >
  ...
  <div className="w-full md:w-auto">
    ...
    {/* Icons aligned below heading */}
    <div className="flex justify-start md:justify-start space-x-4 mb-6 text-gray-600">
      <a
      ...
      <a
        href="https://www.instagram.com/dipdopdrip"
        target="_blank"
        rel="noopener noreferrer"
        className="hover:text-gray-400"
      >
